...
-- https://stackoverflow.com/questions/60839725/how-to-insert-an-error-into-another-table-from-a-function-in-postgres
-- https://www.postgresql.org/docs/current/plpgsql-transactions.html
-- https://stackoverflow.com/questions/60839725/how-to-insert-an-error-into-another-table-from-a-function-in-postgres
...
CREATE OR REPLACE PROCEDURE insert_event_procedure(
    lg_id integer,
    en_id integer,
